...
class ProveedorServiceTest {
    ...
    void setUp() {
        ...
        proveedorService = new ProveedorService(proveedorRepository, productoRepository);
    }
    ...
    void eliminarProveedor() {
        ...
        when(productoRepository.existsByProveedor_Id(5L)).thenReturn(false);
